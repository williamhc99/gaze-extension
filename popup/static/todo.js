...
// takes in text field input and array of autocomplete items
function autocomplete(input, arr) {
  var currentFocus;
  // event listener for text field input
  input.addEventListener("input", function(e) {
      ...
      if (!val) { return false;}
      currentFocus = -1;
      // DIV for list of autocomplete values
      a = document.createElement("DIV");
      a.setAttribute("id", this.id + "autocomplete-list");
      a.setAttribute("class", "autocomplete-items");
      // appends DIV into a parent container (.autocomplete)
      this.parentNode.appendChild(a);
      // checking which items in the array matches 
